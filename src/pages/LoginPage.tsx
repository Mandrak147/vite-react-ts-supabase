          ...
          <form className="p-6 space-y-6">
            ...
            <div className="flex gap-4 flex-col sm:flex-row">
              ...
              <button
                ...
                disabled={loading || !formState.isValid}
                className="cursor-pointer flex-1 bg-white dark:bg-gray-700 text-indigo-600 dark:text-indigo-400 border border-indigo-600 dark:border-indigo-400 py-3 px-4 rounded-lg hover:bg-indigo-50 dark:hover:bg-gray-600 disabled:opacity-50 transition-colors shadow-sm font-medium"
              >
